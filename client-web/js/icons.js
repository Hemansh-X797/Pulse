// Vendored Lucide icon paths (ISC-licensed, see vendor/lucide/).
// Kept as inline path data rather than <img> tags so icons inherit
// `currentColor` and respond to hover/active states like real UI icons.
const PATHS = {
  ...
  flame: '<path d="M12 3c-1.5 3-1 5.5.5 7.5C13.5 12 14 13.5 13.5 15c-.3 1-.6 2-2.5 2-2.5 0-4-2-4-4.5C7 9 8.5 6.5 12 3z"/><path d="M8.5 14.5A2.5 2.5 0 0 0 11 17a4.5 4.5 0 0 0 4.5-4.5c0-1.5-.5-2.5-1-3.5"/>',
  heart: '<path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.29 1.5 4.05 3 5.5l7 7Z"/>',
...
export function icon(name, size = 16) {
  ...
  return `<span class="icon" style="width:${size}px;height:${size}px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${inner}</svg></span>`;
}
